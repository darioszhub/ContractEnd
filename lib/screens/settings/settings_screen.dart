    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          CheckboxListTile(
            contentPadding: EdgeInsets.zero,
            title: const Text('Controlla le scadenze all\'avvio dell\'app'),
          ...
          CheckboxListTile(
            contentPadding: EdgeInsets.zero,
            title: const Text('Il giorno della scadenza'),
            value: setting.notifyOnExpiration,
            onChanged: setting.notificationsEnabled
                ? (value) async {
                    if (value == null) return;
          ...
          CheckboxListTile(
            contentPadding: EdgeInsets.zero,
            title: const Text('Notifica per i contratti già scaduti'),
